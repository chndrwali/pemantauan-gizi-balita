...
export type DiaryWhereInput = {
  ...
  text?: Prisma.StringFilter<"Diary"> | string
...
export type DiaryScalarWhereWithAggregatesInput = {
  ...
  text?: Prisma.StringWithAggregatesFilter<"Diary"> | string
...
export type DiaryOmit<ExtArgs extends runtime.Types.Extensions.InternalArgs = runtime.Types.Extensions.DefaultArgs> = runtime.Types.Extensions.GetOmit<"id" | "title" | "text" | "createdAt", ExtArgs["result"]["diary"]>
...
export interface DiaryFieldRefs {
  ...
  readonly text: Prisma.FieldRef<"Diary", 'String'>
